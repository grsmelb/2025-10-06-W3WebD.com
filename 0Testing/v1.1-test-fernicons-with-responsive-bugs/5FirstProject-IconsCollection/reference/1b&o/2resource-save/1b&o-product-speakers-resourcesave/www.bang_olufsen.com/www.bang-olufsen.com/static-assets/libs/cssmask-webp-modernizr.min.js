...
! function(e, n, t) {
    ...
    function i() {
        ...
        for (var l in _)
            if (_.hasOwnProperty(l)) {
                if (e = [], n = _[l], n.name && (e.push(n.name.toLowerCase()), n.options && n.options.aliases && n.options.aliases.length))
                    for (t = 0; t < n.options.aliases.length; t++) e.push(n.options.aliases[t].toLowerCase());
                for (r = o(n.fn, "function") ? n.fn() : n.fn, i = 0; i < e.length; i++) s = e[i], a = s.split("."), 1 === a.length ? Modernizr[a[0]] = r : (!Modernizr[a[0]] || Modernizr[a[0]] instanceof Boolean || (Modernizr[a[0]] = new Boolean(Modernizr[a[0]])), Modernizr[a[0]][a[1]] = r), w.push((r ? "" : "no-") + a.join("-"))
            }
    }
    ...
    function h(e, n, r, i) {
        ...
        for (var f, c, p, d, m, h = ["modernizr", "tspan", "samp"]; !T.style && h.length;) f = !0, T.modElem = l(h.shift()), T.style = T.modElem.style;
        for (p = e.length, c = 0; p > c; c++)
            if (d = e[c], m = T.style[d], a(d, "-") && (d = A(d)), T.style[d] !== t) {
                if (i || o(r, "undefined")) return s(), "pfx" == n ? d : !0;
                try {
                    T.style[d] = r
                } catch (v) {}
    ...
    function v(e, n, t, r, i) {
        ...
        return o(n, "string") || o(n, "undefined") ? h(a, n, r, i) : (a = (e + " " + E.join(s + " ") + s).split(" "), f(a, n, t))
    }
    ...
    Modernizr._q.unshift(function() {
        delete T.style
    }), C.testAllProps = v, C.testAllProps = y, Modernizr.addTest("cssmask", y("maskRepeat", "repeat-x", !0)), i(), r(w), delete C.addTest, delete C.addAsyncTest;
