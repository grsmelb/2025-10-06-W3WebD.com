(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [3171, 8944, 484], {
        38944: function(e, t, n) {
            ...
            var g = (0, u.Z)((function(e) {
                    var t, n = e.backgroundVideo,
                        i = e.className,
                        o = e.isRichMediaVideoOnCategoryPageProductCardCarousel,
                        u = e.ratio,
                        l = e.storyAutoPlayed,
                        d = e.parentRef,
                        f = e.isSmallBtn,
                        ...
                        k = (0, a.useRef)(null),
                        C = function(e) {
                            e.stopPropagation(), o && e.preventDefault(), t()
                        },
                        E = function(e) {
                            var t = null === k || void 0 === k ? void 0 : k.current,
                                n = null === t || void 0 === t ? void 0 : t.getElementsByClassName("pause-button-wrapper"),
                                i = n && (null === n || void 0 === n ? void 0 : n.length) && n[0];
                            i && !t.contains(e.relatedTarget) && (i.classList.remove("show-btn"), i.classList.add("hide-btn"))
                        };
                    (0, a.useEffect)((function() {
                        var e = null === k || void 0 === k ? void 0 : k.current;
                        return e.addEventListener("focusout", E),
                            function() {
                                e.removeEventListener("focusout", E)
                            }
                    }), []);
                    var Z = function() {
                        var e = null === k || void 0 === k ? void 0 : k.current,
                    ...
                    (0, a.useEffect)((function() {
                        ...
                        return e && (e.addEventListener("mouseover", Z), e.addEventListener("mouseout", E)),
                            function() {
                                e && (e.addEventListener("mouseover", Z), e.addEventListener("mouseout", E))
                            }
                    }), []);
                    var S = null === n || void 0 === n ? void 0 : n.getIn(["media", "defaultAssetUrl"]),
                        I = l || (null === n || void 0 === n ? void 0 : n.getIn(["media", "autoPlay"])),
                        B = null === n || void 0 === n ? void 0 : n.getIn(["media", "enableLoop"]),
                        M = l || (null === n || void 0 === n ? void 0 : n.getIn(["media", "autoPlay"])),
                        L = {
                            mediaItem: n,
                            trackVideo: !1,
                            controls: !M
                        },
                        N = w || v ? "show-btn" : "hide-btn",
                        _ = r()(i, "a-richMediaVideo", {
                            setRatio: u,
                            isCarouselVideo: g
                        });
                    return (0, m.jsxs)("div", {
                        ...
                        onMouseOver: function(e) {
                            e.stopPropagation(), w || P(!0)
                        },
                        onMouseLeave: function(e) {
                            e.stopPropagation(), w && P(!1)
                        },
                        tabIndex: "0",
                        onFocus: function(e) {
                            return Z()
                        ...
                        children: [M && (0, m.jsx)("div", {
                            className: "pause-button-wrapper ".concat(N, " ").concat(f ? "-isSmallBtn" : ""),
                            tabIndex: "0",
                            role: "button",
                            onClick: C,
                            onKeyUp: function(e) {
                                return (null === e || void 0 === e ? void 0 : e.keyCode) === p.q70 && C(e)
                            },
                            ...
                            isRichMediaVideoOnCategoryPageProductCardCarousel: o,
                            videoInlineStyles: b
                        }, L), S)]
                    })
                })),
        ...
        6966: function(e, t, n) {
            ...
            var L = function(e) {
                ...
                function n(e) {
                    var o;
                    (0, i.Z)(this, n), o = t.call(this, e), (0, u.Z)((0, r.Z)(o), "onResize", (function() {
                        o.container.forEach((function(e, t) {
                            var n = o.container[t].current,
                                i = n && n.offsetWidth,
                                r = (0, k.Gu)(i);
                            n && (n.style.minHeight = "".concat(r, "px"))
                        }))
                    })), (0, u.Z)((0, r.Z)(o), "renderImage", (function(e) {
                        var t = {
                            media: e.get("media"),
                            ratio: [16, 9]
                        };
                        return (0, S.jsx)(x.Z, B({}, t))
                    })), o.container = [];
                    var a = o.props.data;
                    return a && a.get("item") && a.get("item").size && a.get("item").forEach((function(e, t) {
                        o.container[t] = (0, l.createRef)()
                    })), o
                }
                return (0, o.Z)(n, [{
                    ...
                    value: function() {
                        var e = this,
                            ...
                            a = t.locale,
                            c = t.country,
                            s = r && r.getIn(["isSmallerThan", "xSmall"]),
                            u = r && r.getIn(["isSmallerThan", "medium"]),
                            p = n.get("item"),
                            f = n.get("title"),
                            h = n.get("description"),
                            g = p.size,
                            b = m()("richMediaWrapper row", {
                                "-centerAligned": g < 3
                            }),
                            v = u && !s ? m()("col-xs-6", {
                                "-listAligned": 3 === g
                        ...
                        return (0, S.jsx)("div", {
                            ...
                            children: (0, S.jsxs)(j.Z, {
                                useMargin: !0,
                                children: [(f || h) && (0, S.jsxs)("div", {
                                    className: "col-xs-12 col-sm-offset-2 col-sm-8 textWrapper",
                                    children: [f && (0, S.jsx)("h2", {
                                        "data-sln-id": "".concat(o, "_title"),
                                        className: "h3 -noMargin richMediaTitle",
                                        children: f
                                    }), h && (0, S.jsx)("div", {
                                        className: "richTextDescriptionWrapper",
                                        children: (0, S.jsx)(O.Z, {
                                            data: h,
                                            "data-sln-id": "".concat(o, "_description"),
                                            className: "b1 -wrapperDesc"
                                        })
                                    })]
                                }), (0, S.jsx)("div", {
                                    className: b,
                                    children: p.map((function(t, n) {
                                        var i = t && t.get("title"),
                                            ...
                                            u = t.get("descriptionRichText"),
                                            p = t && t.get("mediaItem"),
                                            m = t && t.get("showDescriptionOnMobile"),
                                            f = t && t.get("callToAction"),
                                            h = null === f || void 0 === f ? void 0 : f.get("buttonColor"),
                                            g = (null === f || void 0 === f ? void 0 : f.get("theme")) || "secondary",
                                            b = (0, k.HB)(f, a, c),
                                            y = b.href,
                                            x = b.text,
                                            j = b.target,
                                            ...
                                            L = {
                                                href: y,
                                                target: j || "_self",
                                                ariaLabel: M = i && r ? "".concat(i, " : ").concat(r, " : ").concat(M) : i ? "".concat(i, " : ").concat(M) : "".concat(r, " : ").concat(M)
                                            },
                                            N = p && "image" === p.get("mediaType"),
                                            _ = p && ("video" === p.get("mediaType") || "externalVideo" === p.get("mediaType"));
                                        return (0, S.jsx)(l.Fragment, {
                                            children: (0, S.jsxs)("div", {
                                                className: v,
                                                children: [p && (0, S.jsxs)("div", {
                                                    ref: e.container[n],
                                                    className: "-richMedia__bg",
                                                    children: [N && (f ? (0, S.jsx)(C.Z, B(B({
                                                        cta: f
                                                    }, L), {}, {
                                                        children: e.renderImage(p)
                                                    })) : e.renderImage(p)), _ && (0, S.jsx)(Z.Z, {
                                                        backgroundVideo: p,
                                                        isSmallBtn: !0
                                                    })]
                                                }), (0, S.jsxs)("div", {
                                                    className: "".concat(p ? "-minhir" : ""),
                                                    children: [i && (f ? (0, S.jsx)(C.Z, B(B({
                                                        cta: f
                                                    }, L), {}, {
                                                        children: (0, S.jsx)("h3", {
                                                            className: "h5 -title",
                                                        ...
                                                        children: (0, S.jsx)("h3", {
                                                            className: "h4 -richMedia__subtitle",
                                                            children: r
                                                        })
                                                    })) : (0, S.jsx)("h3", {
                                                        className: "h4 -richMedia__subtitle",
                                                        ...
                                                        className: "b1 -richMediaDescription ".concat(m && "showDesc"),
                                                        data: (0, d.fromJS)({
                                                            description: s
                                                        }),
                                                        slnId: o,
                                                    ...
                                                    children: (0, S.jsx)(w.Z, {
                                                        ...
                                                        labelText: x,
                                                        target: j,
                                                        tertiaryBtnHoverColor: P.Z.BEO_BLACK,
                                                        ariaLabel: I,
                                                        buttonColor: h
                                                    })
                                                })]
                ...
                return function(t) {
                    ...
                    function c(e) {
                        ...
                        return (0, o.Z)(this, c), (t = n.call(this, e)).state = {
                            deviceInfo: (0, l.fromJS)({}),
                            viewportInfo: (0, l.fromJS)({})
                        }, t
                    }
                    return (0, r.Z)(c, [{
                        key: "componentDidMount",
                        value: function() {
                            this.setState({
                                deviceInfo: (0, l.fromJS)((0, d.dz)()),
                                viewportInfo: (0, l.fromJS)((0, d.yK)())
                            })
                        }
                    }, {
                        key: "render",
        ...
        20484: function(e) {
            "undefined" !== typeof e.exports && (e.exports = function(e) {
                ...
                var t = navigator.userAgent.indexOf("Edge/") >= 0,
                    n = new Image,
                    i = "object-fit" in n.style && !t,
                    o = "object-position" in n.style && !t,
                    r = /(object-fit|object-position)\s*:\s*([-\w\s%]+)/g;

                function a(e) {
                    for (var t = getComputedStyle(e).fontFamily, n = null, i = {}; null !== (n = r.exec(t));) i[n[1]] = n[2];
                    return i["object-position"] ? function(e) {
                ...
                function c(e, t) {
                    if ("fill" !== t["object-fit"]) {
                        ...
                        n.border = n.margin = n.padding = 0, n.display = "block", n.opacity = 1, e.addEventListener("loadedmetadata", c), window.addEventListener("optimizedResize", c), e.readyState >= 1 && (e.removeEventListener("loadedmetadata", c), c())
                    }
                    ...
                    function c() {
                        var i = e.videoWidth / e.videoHeight,
                            ...
                            s = 0,
                            u = 0;
                        n.marginLeft = n.marginTop = 0, (i < c ? "contain" === t["object-fit"] : "cover" === t["object-fit"]) ? (s = a * i, u = r / i, n.width = Math.round(s) + "px", n.height = a + "px", "left" === t["object-position-x"] ? n.marginLeft = 0 : "right" === t["object-position-x"] ? n.marginLeft = Math.round(r - s) + "px" : n.marginLeft = Math.round((r - s) / 2) + "px") : (u = r / i, n.width = r + "px", n.height = Math.round(u) + "px", "top" === t["object-position-y"] ? n.marginTop = 0 : "bottom" === t["object-position-y"] ? n.marginTop = Math.round(a - u) + "px" : n.marginTop = Math.round((a - u) / 2) + "px"), e.autoplay && e.play()
                    }
                }
                i && o || (function(e) {
                    var t = -1;
                    ...
                    for (; e[++t];) {
                        var n = a(e[t]);
                        (n["object-fit"] || n["object-position"]) && (n["object-fit"] = n["object-fit"] || "fill", c(e[t], n))
                    }
                }(e), function(e, t, n) {
                    n = n || window;
                    var i = !1,
