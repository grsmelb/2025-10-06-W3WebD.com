        ...
        63594: function(t) {
            ...
            function g(t) {
                ...
                if (n["object-fit"] = n["object-fit"] || "fill", !r.img) {
                    ...
                    if (!r.skipTest && o && !n["object-position"]) return
                }
                if (!r.img) {
                    r.img = new Image(t.width, t.height), r.img.srcset = a.call(t, "data-ofi-srcset") || t.srcset, r.img.src = a.call(t, "data-ofi-src") || t.src, l.call(t, "data-ofi-src", t.src), t.srcset && l.call(t, "data-ofi-srcset", t.srcset), d(t, t.naturalWidth || t.width, t.naturalHeight || t.height), t.srcset && (t.srcset = "");
                    try {
                        ! function(t) {
                            var i = {
                                get: function(i) {
                                ...
                                set: function(i, n) {
                                    return t[e].img[n || "src"] = i, l.call(t, "data-ofi-" + n, i), g(t), i
                                }
                            };
                ...
                }(r.img), t.style.backgroundImage = 'url("' + (r.img.currentSrc || r.img.src).replace(/"/g, '\\"') + '")', t.style.backgroundPosition = n["object-position"] || "center", t.style.backgroundRepeat = "no-repeat", t.style.backgroundOrigin = "content-box", /scale-down/.test(n["object-fit"]) ? f(r.img, (function() {
                    r.img.naturalWidth > t.width || r.img.naturalHeight > t.height ? t.style.backgroundSize = "contain" : t.style.backgroundSize = "auto"
                })) : t.style.backgroundSize = n["object-fit"].replace("none", "auto").replace("fill", "100% 100%"), f(r.img, (function(e) {
            ...
            function p(t, i) {
                var n = !u && !t;
                if (i = i || {}, t = t || "img", r && !i.skipTest || !c) return !1;
                ...
                }), !0), u = !0, t = "img"), i.watchMQ && window.addEventListener("resize", p.bind(null, t, {
                    skipTest: i.skipTest
                }))
            }
            ...
            "undefined" !== typeof t.exports && (t.exports = function(t) {
                ...
                function s(t, e) {
                    if ("fill" !== e["object-fit"]) {
                        ...
                        i.border = i.margin = i.padding = 0, i.display = "block", i.opacity = 1, t.addEventListener("loadedmetadata", s), window.addEventListener("optimizedResize", s), t.readyState >= 1 && (t.removeEventListener("loadedmetadata", s), s())
                    }
                    ...
                    function s() {
                        var n = t.videoWidth / t.videoHeight,
                            ...
                            a = 0,
                            l = 0;
                        i.marginLeft = i.marginTop = 0, (n < s ? "contain" === e["object-fit"] : "cover" === e["object-fit"]) ? (a = c * n, l = r / n, i.width = Math.round(a) + "px", i.height = c + "px", "left" === e["object-position-x"] ? i.marginLeft = 0 : "right" === e["object-position-x"] ? i.marginLeft = Math.round(r - a) + "px" : i.marginLeft = Math.round((r - a) / 2) + "px") : (l = r / n, i.width = r + "px", i.height = Math.round(l) + "px", "top" === e["object-position-y"] ? i.marginTop = 0 : "bottom" === e["object-position-y"] ? i.marginTop = Math.round(c - l) + "px" : i.marginTop = Math.round((c - l) / 2) + "px"), t.autoplay && t.play()
                    }
                }
                n && o || (function(t) {
                    var e = -1;
                    ...
                    for (; t[++e];) {
                        var i = c(t[e]);
                        (i["object-fit"] || i["object-position"]) && (i["object-fit"] = i["object-fit"] || "fill", s(t[e], i))
                    }
                }(t), function(t, e, i) {
                    i = i || window;
                    var n = !1,
